...
ARG SOURCE_DIGEST=f4ef9f0cdc4b7da083c3c0c0d18444278db7d05df1b55bebdb0df296ff38a61d
FROM gematik1/osadl-alpine-openjdk21-jre:1.0.7@sha256:${SOURCE_DIGEST}
...
COPY --chown=$USERID:$GROUPID target/notification-routing-service.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="DEMIS Notification Routing Service" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/git/demis/services/notification-routing-service" \
