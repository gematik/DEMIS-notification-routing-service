...
## Release 2.6.0
- Removed work around for cologne and tests for workaround
- Removed config flag nrs.workaroundForCologne
- Removed istio helm chart
- updated base-image and updated from java 21 to java 25
- updated spring-parent to version 2.15.5
- activated feign header forwarding
- fixed bug for non-evaluable notifications in routing context when a result is empty
- added FEATURE_FLAG_NEW_ERROR_MESSAGE_FOR_FAILED_ROUTING
- removed FEATURE_FLAG_NOTIFICATIONS_7_3 and FEATURE_FLAG_FOLLOW_UP_NOTIFICATION
- removed routing configurations for 7.3 and follow-up notifications
- removed tests for 7.3 and follow-up notifications
