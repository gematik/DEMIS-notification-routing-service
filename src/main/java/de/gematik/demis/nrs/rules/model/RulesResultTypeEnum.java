...
public enum RulesResultTypeEnum {
  ...
  RESPONSIBLE_HEALTH_OFFICE("responsible_health_office", 2),
  ...
  RESPONSIBLE_HEALTH_OFFICE_WITH_RELATES_TO("responsible_health_office_with_relates_to", 1),
  @JsonProperty("specific_receiver")
  SPECIFIC_RECEIVER("specific_receiver", 5),
  OTHER("", 99),
  @JsonProperty("responsible_health_office_tuberculosis")
  RESPONSIBLE_HEALTH_OFFICE_TUBERCULOSIS("responsible_health_office_tuberculosis", 3);
